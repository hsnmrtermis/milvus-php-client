...
/**
 * Generated from protobuf message <code>milvus.proto.data.MarkSegmentsDroppedRequest</code>
 */
class MarkSegmentsDroppedRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $base = null;
    /**
     * IDs of segments that needs to be marked as `dropped`.
     *
