...
/**
 * Generated from protobuf message <code>milvus.proto.data.UnsetIsImportingStateRequest</code>
 */
class UnsetIsImportingStateRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $base = null;
    /**
     * IDs of segments whose `isImport` states need to be unset.
     *
     * Generated from protobuf field <code>repeated int64 segment_ids = 2;</code>
     */
    private $segment_ids;
