...
/**
 * Generated from protobuf message <code>milvus.proto.proxy.InvalidateCollMetaCacheRequest</code>
 */
class InvalidateCollMetaCacheRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * MsgType:
