...
/**
 * Generated from protobuf message <code>milvus.proto.query.SyncDistributionRequest</code>
 */
class SyncDistributionRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $channel = '';
    /**
     * Generated from protobuf field <code>repeated .milvus.proto.query.SyncAction actions = 4;</code>
     */
    private $actions;
     ...
     *     @type string $channel
     *     @type array<\Milvus\Proto\Query\SyncAction>|\Google\Protobuf\Internal\RepeatedField $actions
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .milvus.proto.query.SyncAction actions = 4;</code>
     * @param array<\Milvus\Proto\Query\SyncAction>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setActions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Milvus\Proto\Query\SyncAction::class);
        $this->actions = $arr;
